...
export const dpProblems: CodingProblemSeedInput[] = [
  {
    ...
    description: `Given an input configuration, solve the Coin Change Minimum Coins problem efficiently satisfying all time and memory complexity constraints.`,
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Longest Increasing Subsequence problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Dynamic Programming',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Longest Common Subsequence problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Dynamic Programming',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the 0-1 Knapsack Maximum Value problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Dynamic Programming',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the House Robber Maximum Amount problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Dynamic Programming',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Edit Distance Minimum Operations problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'HARD',
    topic: 'Dynamic Programming',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Partition Equal Subset Sum problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Dynamic Programming',
