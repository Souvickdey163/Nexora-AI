...
export const searchingProblems: CodingProblemSeedInput[] = [
  {
    ...
    description: `Given an input configuration, solve the Binary Search Sorted Array Index problem efficiently satisfying all time and memory complexity constraints.`,
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Search in Rotated Sorted Array problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Searching',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Find First and Last Position of Element problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Searching',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Search a 2D Sorted Matrix problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Searching',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Find Peak Element Local Maximum problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Searching',
...
public:
  ...
  },
  {
    ...
    description: `Given an input configuration, solve the Koko Eating Bananas Minimum Speed problem efficiently satisfying all time and memory complexity constraints.`,
    source: 'Nexora Original',
    license: 'MIT',
    difficulty: 'MEDIUM',
    topic: 'Searching',
